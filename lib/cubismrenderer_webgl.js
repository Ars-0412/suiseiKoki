 ...
 */
// import removed: { csmMap } from '../type/csmmap';
// import removed: { csmVector } from '../type/csmvector';
// import removed: { CubismLogError } from '../utils/cubismdebug';
// import removed: { CubismClippingManager } from './cubismclippingmanager';
// import removed: { CubismClippingContext, CubismRenderer } from './cubismrenderer';
// import removed: { CubismShaderManager_WebGL } from './cubismshader_webgl';
let s_viewport;
let s_fbo;
/**
 * クリッピングマスクの処理を実行するクラス
 */
// export removed: class CubismClippingManager_WebGL extends CubismClippingManager {
    /**
 ...
 * クリッピングマスクで使用する
 */
// export removed: class CubismRenderTextureResource {
    /**
     * 引数付きコンストラクタ
 ...
 * クリッピングマスクのコンテキスト
 */
// export removed: class CubismClippingContext_WebGL extends CubismClippingContext {
    /**
     * 引数付きコンストラクタ
     */
...
// export removed: class CubismRendererProfile_WebGL {
 ...
 * WebGL用の描画命令を実装したクラス
 */
// export removed: class CubismRenderer_WebGL extends CubismRenderer {
    /**
     * レンダラの初期化処理を実行する
...
// import removed: * as $ from './cubismrenderer_webgl';
// eslint-disable-next-line @typescript-eslint/no-namespace
// export removed: var Live2DCubismFramework;
