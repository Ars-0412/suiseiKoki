...
// import removed: { CubismBlendMode, CubismTextureColor } from '../rendering/cubismrenderer';
// import removed: { csmMap } from '../type/csmmap';
// import removed: { csmVector } from '../type/csmvector';
// import removed: { CSM_ASSERT } from '../utils/cubismdebug';
/**
 * SDK側から与えられたDrawableの乗算色・スクリーン色上書きフラグと
 * その色を保持する構造体
 */
// export removed: class DrawableColorData {
 ...
 */
// export removed: class PartColorData {
    constructor(isOverwritten = false, color = new CubismTextureColor()) {
        this.isOverwritten = isOverwritten;
        this.color = color;
    }
 ...
 */
// export removed: class DrawableCullingData {
    /**
     * コンストラクタ
     *
     * @param isOverwritten
 ...
 */
// export removed: class CubismModel {
    /**
     * モデルのパラメータの更新
     */
    update() {
...
// import removed: * as $ from './cubismmodel';
