 ...
 */
// import removed: { CSM_ASSERT, CubismLogError } from '../utils/cubismdebug';
// import removed: { CubismModel } from './cubismmodel';
/**
 * Mocデータの管理
 *
 * Mocデータの管理を行うクラス。
 */
// export removed: class CubismMoc {
    /**
     * Mocデータの作成
     */
...
// import removed: * as $ from './cubismmoc';
