 ...
 */
// import removed: { CubismMatrix44 } from '../math/cubismmatrix44';
// import removed: { csmRect } from '../type/csmrectf';
/**
 * モデル描画を処理するレンダラ
 *
 * サブクラスに環境依存の描画命令を記述する。
 */
// export removed: class CubismRenderer {
    /**
...
// export removed: var CubismBlendMode;
 ...
 */
// export removed: class CubismTextureColor {
    /**
     * コンストラクタ
     */
 ...
 * クリッピングマスクのコンテキスト
 */
// export removed: class CubismClippingContext {
    /**
     * 引数付きコンストラクタ
     */
...
// import removed: * as $ from './cubismrenderer';
